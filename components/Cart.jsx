...
export default function Cart({cartitems,cartClose, deleteItem}) {
  ...
  return (
    <div className="fixed top-0 bottom-0 left-0 right-0 opacity-95 flex items-end justify-end lg:items-end lg:justify-end   md:items-end md:justify-end  bg-themed2 lg:py-5 px-0 lg:px-3  overflow-y-auto ">
        
         <div className=" w-full   lg:w-1/3 opacity-100 lg:py-10 px-5 bg-slate-300 lg:px-10 mb-20 ">
